...
$DBAid_src = "$SourceRootFolder\DBAid-build_6.1.0" # Root folder for dbaid source files.
...
$EmailFrom = "$hostname@client.co.nz"        # Who the collector files came from (usually <hostname|VNN@domain.co.nz)
