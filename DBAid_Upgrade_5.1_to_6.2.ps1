...
$DBAidnew_source = "$SourceRootFolder\DBAid-build-6.2.0\"                  # Source files for new version of DBAid
...
try {
  [xml]$oldfile = Get-Content "$DBAidold_checkmk_backup\$checkmk_config" -Raw
